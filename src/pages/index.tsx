  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Online Grocery Store, your one-stop destination for amazing deals on food and groceries in major city areas. Fresh vegetables and food, just a click away!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1695653422881-6372da5e29e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxncm9jZXJ5fGVufDB8fHx8MTY5NzE4NDA3M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Online Grocery Store, your one-stop destination for amazing deals on food and groceries in major city areas. Fresh vegetables and food, just a click away!`}
            </Text>
            <Box
