...
import { useGrocerFindFirst, useRoqClient } from 'lib/roq';
...
function GrocerViewPage() {
  ...
  const { data, error, isLoading } = useGrocerFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('grocer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/grocers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="grocer" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
